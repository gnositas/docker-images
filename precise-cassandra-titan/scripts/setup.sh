...
cp -r rexster-server-2.5.0/* /usr/local/rexster
rm -rf rexster-server-2.5.0
...
rm titan-all-0.4.4.zip
cp -r titan-all-0.4.4/lib/*.* /usr/local/rexster/ext/titan
cp -r titan-all-0.4.4/* /usr/local/titan
rm -rf titan-all-0.4.4
